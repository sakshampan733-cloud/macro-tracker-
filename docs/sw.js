...
const CACHE = 'basal-2026.09.06-overbudget';
...
const SHELL = [
  ...
  'js/data/foodsync.js', 'js/healthkit.js', 'js/nativestore.js', 'js/widget.js', 'js/data/classify.js', 'js/data/exercises.js', 'js/data/workouts.js',
